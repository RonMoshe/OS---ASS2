...
int main(int argc, char* argv[])
{
   ...
   c:	366080e7          	jalr	870(ra) # 36e <get_cpu>
  10:	85aa                	mv	a1,a0
  12:	00000517          	auipc	a0,0x0
  16:	7de50513          	addi	a0,a0,2014 # 7f0 <malloc+0xe4>
  1a:	00000097          	auipc	ra,0x0
  1e:	634080e7          	jalr	1588(ra) # 64e <printf>
    set_cpu(new_cpu);
  22:	4509                	li	a0,2
  24:	00000097          	auipc	ra,0x0
  28:	342080e7          	jalr	834(ra) # 366 <set_cpu>
    printf("cpu after calling to set_cpu(2): %d\n", get_cpu());
  2c:	00000097          	auipc	ra,0x0
  30:	342080e7          	jalr	834(ra) # 36e <get_cpu>
  34:	85aa                	mv	a1,a0
  36:	00000517          	auipc	a0,0x0
  3a:	7e250513          	addi	a0,a0,2018 # 818 <malloc+0x10c>
  3e:	00000097          	auipc	ra,0x0
  42:	610080e7          	jalr	1552(ra) # 64e <printf>
    exit(0);
  46:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3be:	48e50513          	addi	a0,a0,1166 # 848 <digits>
 3c2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 48a:	3c2b8b93          	addi	s7,s7,962 # 848 <digits>
 ...
 5ca:	27a90913          	addi	s2,s2,634 # 840 <malloc+0x134>
        while(*s != 0){
...
free(void *ap)
{
 ...
 692:	1d27b783          	ld	a5,466(a5) # 860 <freep>
 ...
 6c0:	00e6ea63          	bltu	a3,a4,6d4 <free+0x50>
{
 ...
 702:	16f73123          	sd	a5,354(a4) # 860 <freep>
}
 706:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 734:	13053503          	ld	a0,304(a0) # 860 <freep>
 ...
 75c:	10890913          	addi	s2,s2,264 # 860 <freep>
  if(p == (char*)-1)
 760:	5afd                	li	s5,-1
 762:	a88d                	j	7d4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 764:	00000797          	auipc	a5,0x0
 768:	10478793          	addi	a5,a5,260 # 868 <base>
 76c:	00000717          	auipc	a4,0x0
 770:	0ef73a23          	sd	a5,244(a4) # 860 <freep>
 774:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 796:	0ca73723          	sd	a0,206(a4) # 860 <freep>
      return (void*)(p + 1);
